...
<applet code=diet.server.experimentmanager.EMStarterApplet.class 
      ...
      width=160 height=80 MAYSCRIPT ALT="If you can't see a button here you won't be able to run the experiment...If you are running MTURK, please choose to release the assignment! SORRY">
<PARAM name="userentersvalues" value= "yes">
<PARAM name="serveripaddress" value= <?php echo $_SERVER["SERVER_NAME"];?>>
<PARAM name="serverportnumber" value= "20000">
</applet>
