...
public class ConversationHistories {
     ...
     public TurnMazeGame addNormalMazeGameTurn(long timeOfCreationOnClient,long onset, long enter, String senderUsername, String apparentSenderUsername, String text,
        ...
        TurnMazeGame t = currentHistoryBeingProcessed.saveMessageFromCRMazeGame(timeOfCreationOnClient,onset, enter, senderUsername, apparentSenderUsername, text, recipientsNames, wasBlocked, keyPresses, documentUpdates, turnNumber, descType,ackCROther,null);
