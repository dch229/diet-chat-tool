...
public class Turn implements Serializable{
  ...
  public long timeOfCreationOnClient = -9999;
  public Object[] priorTurnByOtherONTHEUSERINTERFACE; //THIS IS FROM THE UI
   ...
   public Turn(){
    ...
    public Turn (ConversationHistory cH,long timeOfCreationOnClient,String type, long onset, long enter,Conversant sender, Conversant apparentSender,String text,
          Vector recipients,boolean wasBlocked,Vector keyPresses,Vector documentUpdates,Vector parsedWords,Object parseTree,long turnNo, Vector additionalStrings, Object[] priorTurnByOther){
          this.timeOfCreationOnClient=timeOfCreationOnClient;
          ...
          this.priorTurnByOtherONTHEUSERINTERFACE=priorTurnByOther;
    ...
    public void setStartTimeOfExperimentDEPRECATED(long startTimeOfExperiment) {
    ...
    public long getCreationTimeOnClient(){
        return this.timeOfCreationOnClient;
    }
    ...
    public Object[] getPriorTurnByOther_NotUSED(){
        return this.priorTurnByOtherONTHEUSERINTERFACE;
    }
    
    public String[] getPriorTurnByOtherAsString(){
        String prior_timeOfReceiptOnClient =" ";
        String prior_usernameOfSender = " ";
        String prior_text ="                                                                                       ";
        if(priorTurnByOtherONTHEUSERINTERFACE==null){
            //return new String[]{prior_timeOfReceiptOnClient,prior_usernameOfSender,(prior_text)};
            return new String[]{"","",""};
        }
        
        try{
            prior_timeOfReceiptOnClient = ""+priorTurnByOtherONTHEUSERINTERFACE[0];
        }catch (Exception e){
            
        }
        try{
            prior_usernameOfSender = (String)priorTurnByOtherONTHEUSERINTERFACE[1];
        }catch (Exception e){
            
        }
        try{
            prior_text = ((String) priorTurnByOtherONTHEUSERINTERFACE[2]).replaceAll("\n", "~");
        }catch (Exception e){
