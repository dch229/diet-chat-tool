...
public class POSEntropyCalc {
    ...
    final static String taggerFileName = System.getProperty("user.dir") +File.separator+"experimentresources"+ File.separator
			+ "utils" + File.separator
	    + "bidirectional-distsim-wsj-0-18.tagger";
    static final File misspellingsFile = new File(System
	    .getProperty("user.dir")+File.separator+"experimentresources"
	    + File.separator
	    + "fragmentFilters"
	    + File.separator
	    + "misspellings.txt");
