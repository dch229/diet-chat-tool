...
public class DefaultSettingsFactory {
    ...
    static public ExperimentSettings getDefaultExperimentParameters(){
        Vector v = new Vector();
        StringParameter sp;
        StringParameterFixed spf;
        IntParameter ip;
        sp = new StringParameter("Experiment ID","experiment");
    ...
    static public ExperimentSettings getDefaultExperimentParametersForAnyCCONTROLLER(){
        Vector v = new Vector();
        StringParameter sp;
        StringParameterFixed spf;
        IntParameter ip;
