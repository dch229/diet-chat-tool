...
public class FragmentIdentifierThread extends Thread{
    ...
    {
        this.pw=new ParserWrapper(System.getProperty("user.dir") +File.separator+"experimentresources"+ File.separator
			+ "utils" + File.separator+"englishPCFG.ser.gz");
        this.setPriority(NORM_PRIORITY);
        this.fi=new FragmentIdentifier(System.getProperty("user.dir")+File.separator+"experimentresources"+File.separator+"fragmentFilters"+File.separator+"filtersTangramDistantCR.txt");
