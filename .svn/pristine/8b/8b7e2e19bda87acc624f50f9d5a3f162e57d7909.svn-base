...
public class JCRSender2Participants3 extends javax.swing.JFrame {
    ...
    CCGROOP3SEQ3 cC;
    AlphabeticalTask3WAY_DEPRECATED_DO_NOT_USE at3WAY;
    ...
    public JCRSender2Participants3(CCGROOP3SEQ3 cC,AlphabeticalTask3WAY_DEPRECATED_DO_NOT_USE at,Participant a, Participant b, int minSize, boolean onlyALLOWED, boolean xorALLOWED, boolean andALLOWED) {
        initComponents();
        this.cC=cC;
        this.at3WAY=at;
        this.a =a;
