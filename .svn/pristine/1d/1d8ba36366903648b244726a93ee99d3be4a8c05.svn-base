...
public class CCCBYCSplitUtterance extends CCCBYCDefaultController{
    ...
    public Sequence getNextSequence_Edit_By_Same_Speaker(Sequence prior, int sequenceNo, Sequences sS, String sender, MessageCBYCDocChangeFromClient mCDC) {
        ...
        if(prior instanceof SplitUttBufferedTarget){
            ...
            return new SplitUttContiguousByTarget((SplitUtt)prior,sS,this,sender,mCDC.getTimeOnServerOfReceipt(),mCDC.getDocChange().elementString,dc.elementStart,dc.elementFinish);
        }
        else if(prior instanceof SplitUttContiguousByTarget){
            return new SplitUttContiguousByTarget((SplitUttContiguousByTarget)prior,sS,this,sender,mCDC.getTimeOnServerOfReceipt(),mCDC.getDocChange().elementString,dc.elementStart,dc.elementFinish);
