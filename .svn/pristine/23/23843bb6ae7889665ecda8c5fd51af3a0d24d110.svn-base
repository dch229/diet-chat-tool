...
public class FragmentIdentifier{
    ...
    public static void main(String args[])
    {
        ...
        FragmentIdentifier fi=new FragmentIdentifier(System.getProperty("user.dir")+File.separator+"experimentresources"+File.separator+"fragmentFilters"+File.separator+"filtersTangramDistantCR.txt");
        
        ParserWrapper pw=new ParserWrapper(System.getProperty("user.dir") +File.separator+"experimentresources"+ File.separator
