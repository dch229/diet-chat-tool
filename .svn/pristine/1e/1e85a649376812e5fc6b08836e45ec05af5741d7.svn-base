...
import diet.task.collabMinitaskProceduralComms3.AlphabeticalTask3WAY_DEPRECATED_DO_NOT_USE;
...
public class CCGROOP3SEQ3 extends DefaultConversationController{
    ...
    AlphabeticalTask3WAY_DEPRECATED_DO_NOT_USE at = new AlphabeticalTask3WAY_DEPRECATED_DO_NOT_USE(this);
