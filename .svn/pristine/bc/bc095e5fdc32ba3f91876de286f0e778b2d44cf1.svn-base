...
public class CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT_SPLIT_WINDOW  extends CCMAZE_DYADIC_MULTI_2_PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE_TIMEOUT implements TaskControllerInterface{
    ...
    public synchronized void processChatText(Participant sender, MessageChatTextFromClient mct){    
           ...
           if(interfaceNumber==0){
               ...
               c.sendArtificialTurnToRecipientWithEnforcedTextColour(sender, sender.getUsername()+": "+mct.getText(),0, info+"FILLER", 0);
