...
public class JSetupFrame extends JFrame{
  ...
  private void jbInit() throws Exception {
    ...
    jLabel1.setBounds(new Rectangle(41, 20, 89, 24));
    jComboBox1.setBounds(new Rectangle(128, 20, 688, 24));
...
class JSetupFrameEventHandler extends JFrame implements java.awt.event.ActionListener{
  ...
  public void actionPerformed(ActionEvent e){
     int mazeindex;
     if(e.getSource().equals(jsp.jComboBox1)){
       mode = 10;
       if(jsp.jComboBox1.getItemCount()>0){
         String name = (String) jsp.jComboBox1.getSelectedItem();
         jsp.cl1mazes = jsp.stpIO.getClient1MazesFromSetupName(name);
         jsp.cl2mazes = jsp.stpIO.getClient2MazesFromSetupName(name);
       ...
       if(jsp.jTextField3.getText().equalsIgnoreCase("")){
         JOptionPane.showMessageDialog(this, "Enter text in name field");
       ...
       else if (jsp.cl1mazes.size()<1){
         JOptionPane.showMessageDialog(this, "Can't save empty mazes");
       }
       else {
          jsp.stpIO.saveClientMazesFromSetupNo(this.jsp.cl1mazes,this.jsp.cl2mazes,jsp.jTextField3.getText());
