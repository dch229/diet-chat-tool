    ...
    private void saveMessageToFile(MessageTask mt){
        ...
        try{
           this.objOutTaskMessage.writeObject(mt);
            ...
            if(mt.getTimeOnServerOfReceipt()!=null){
                line = line + mt.getTimeOnServerOfReceipt().getTime()+"|";
            }
             else{
                line = line + "| |";
            }
            ...
            try{
               System.err.println("ERROR SAVING MESSAGE IN MAZEGAME: "+mt.getTimeOnServerOfReceipt()+mt.getUsername()+mt.getMessageClass()+"  ");
