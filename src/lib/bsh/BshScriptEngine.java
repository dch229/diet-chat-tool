...
public class BshScriptEngine extends AbstractScriptEngine implements Compilable, Invocable {
	...
	private lib.bsh.Interpreter interpreter;
	...
	protected Interpreter getInterpreter() {
		if (interpreter == null) {
			this.interpreter = new lib.bsh.Interpreter();
	...
	*/
	...
	private Object evalSource(Object source, ScriptContext scriptContext) throws ScriptException {
		lib.bsh.NameSpace contextNameSpace = getEngineNameSpace(scriptContext);
	...
	*/
	...
	public Object invokeMethod(Object thiz, String name, Object... args) throws ScriptException, NoSuchMethodException {
		if (!(thiz instanceof lib.bsh.This)) {
			throw new ScriptException("Illegal objec type: " + thiz.getClass());
		}

		lib.bsh.This bshObject = (lib.bsh.This) thiz;
	...
	public <T> T getInterface(Object thiz, Class<T> clasz) {
		...
		lib.bsh.This bshThis = (lib.bsh.This) thiz;
		return clasz.cast(bshThis.getInterface(clasz));
	}


	private lib.bsh.This getGlobal() {
