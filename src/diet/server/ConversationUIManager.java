...
public class ConversationUIManager {
   ...
   // private JControlPanel jcp;
    ...
    public JTabbedPane createConversationTabbedPane(){
        ...
        try{
          ...
          if(c.getTaskController()!=null){
              TaskControllerInterface tc = c.getTaskController();
     ...
     */
    public JFrame createConversationParseTreesDeprecated(){
        try{ 
    ...
    */
     ...
     * @param txt
     */
    public void parseTreeAndDisplayOfParticipantDEPRECATED(Participant p,String txt){
     ...
     * @param t
     */
    private void displayParseTreeOfParticipantDEPRECATED(Participant p, Object o){
