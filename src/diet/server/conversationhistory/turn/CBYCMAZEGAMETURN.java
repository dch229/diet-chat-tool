...
public CBYCMAZEGAMETURN(ConversationHistory cH, long timeOfCreationOnClient,long onset, long enter, Conversant sender, Conversant apparentSender, String text, Vector recipients, boolean wasBlocked, Vector keyPresses, Vector documentUpdates, Vector parsedWords, Object parseTree, int turnNo,
      ...
      {
           this(cH,timeOfCreationOnClient, onset, enter,  sender,  apparentSender, text, recipients, wasBlocked, keyPresses, documentUpdates, parsedWords, parseTree, turnNo,
    ...
    public CBYCMAZEGAMETURN(ConversationHistory cH, long timeOfCreationOnClient,long onset, long enter, Conversant sender, Conversant apparentSender, String text, Vector recipients, boolean wasBlocked, Vector keyPresses, Vector documentUpdates, Vector parsedWords, Object parseTree, int turnNo,
            String eString, int eStart,int eFinish,String type,long timeOfFirstSend,long timeOfLastSend,String finalText,
            int mazeNo,int moveNoATSTART,int indivMoveNoATSTART,int moveNoATEND,int indivMoveNoATEND) {
        super(cH,timeOfCreationOnClient, "CBYCMAZEGAMETURN",onset, enter, sender, apparentSender, text.replaceAll ("\\n", " "), recipients, wasBlocked, keyPresses, documentUpdates, parsedWords,  parseTree, turnNo,new Vector(),null);
