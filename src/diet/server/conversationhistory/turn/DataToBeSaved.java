...
public class DataToBeSaved extends Turn implements Serializable{
  ...
  private Vector additionalValues;
   ...
   public DataToBeSaved(){
    ...
    public DataToBeSaved (ConversationHistory cH,String type, long timeOnClient, long onset, long enter,String senderID, String sender, String apparentSender,String text,
          ...
          super.timeOfCreationOnClient=timeOnClient;
          ...
          priorTurnByOtherONTHEUSERINTERFACE = priorTurnByOther;
          //priorTurnByOtherONTHEUSERINTERFACE[2]= "PRIORTEXT4"+priorTurnByOtherONTHEUSERINTERFACE[2];
