...
public class EMStarterApplet  extends JApplet {
    ...
    public void init() {
       ...
       final String portNUMBEROFSERVER = getParameter("serverportnumber");
       
       String buttonText = "START the chat client";
       
       
       try{
          int n = Integer.parseInt(portNUMBEROFSERVER);
          portNumber = n;
       ...
       final JLabel label = new JLabel("Connect to: "+ipADDRESSOFSERVER);
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               try{
                 ...
                 if(participantId==null||participantId.length()==0||userentersvalues.equalsIgnoreCase("yes")){
                     ConnectionToServer cts = new ConnectionToServer(ip,portNumber);
                     label.setText("Connecting to: "+ipADDRESSOFSERVER);
                     cts.start();
                 }else{
                    ConnectionToServer cts = new ConnectionToServer(ip, portNumber,participantId);
        ...
        getContentPane().add(label);
               ...
               getContentPane().add(new JLabel("There's an error:"));
               getContentPane().add(new JLabel(""+e.toString()));
       }
