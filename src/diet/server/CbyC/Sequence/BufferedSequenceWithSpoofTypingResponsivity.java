...
public class BufferedSequenceWithSpoofTypingResponsivity extends Sequence {
	...
	public BufferedSequenceWithSpoofTypingResponsivity(Sequences sS,
		CCCBYCDefaultController cC, String sender, String condition) {
	    super(sS, cC, sender);
	    this.timeOfLastDocChange = -1;
	    this.condition=condition;
	}
	...
	protected boolean bufferEmptied = false;
	...
	// until the initial buffer's flushed completely
	...
	public void main() {
		...
		{			
			this.cC.resetToNormal();
			stopRecordingDelaysAndSpoofResponsivity();
			bufferEmptied = true;
		}
