...
public class CCMAZE_UWA2013_DYADIC_8PARTICIPANTS_SEPARATE_DYADS_MAZEBYMAZE  extends DefaultConversationController implements TaskControllerInterface{
...
//        if(participantID.equalsIgnoreCase("555555"))return true;
   ...
   public synchronized void performSwapNoFlashing(int newPartnerNumber, int mazeNumber){
    ...
    public static ExperimentSettings getDefaultSettings() {
        ...
        IntParameter ip;
        sp = new StringParameter("Experiment ID","CCMAZE_DYADIC_8PARTICIPANTS_SEPARATEDYADS");
        v.addElement(sp);
