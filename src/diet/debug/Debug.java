...
public class Debug {
    ...
    static public boolean debugGROOP4 = false;
    
    static public boolean debugMAZEGAME = false;
    static public boolean debugMAZEGAME_RANDOMTYPING = false;
    ...
    static public void printDBG_andclear(String s){
        printDBG_andclear("DEFAULT",s);
    }

    static Hashtable ht = new Hashtable();
    static public void printDBG(String windowID,String s){
        DebugWindow dbg = (DebugWindow)ht.get(windowID);
        if (dbg ==null){
            dbg=new DebugWindow(windowID);
            ht.put(windowID, dbg);
        }
         dbg.append(s);
    }
    static public void printDBG_andclear(String windowID,String s){
        DebugWindow dbg = (DebugWindow)ht.get(windowID);
        if (dbg ==null){
            dbg=new DebugWindow(windowID);
            ht.put(windowID, dbg);
