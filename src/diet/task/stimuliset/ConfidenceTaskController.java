...
public class ConfidenceTaskController extends DefaultTaskController{
    ...
    public void saveScoreForParticipant(Participant p){
        ...
        cC.getC().saveDataToConversationHistory(p,cC.getDescriptionForP(p)+"_SCORES" , p.getParticipantID() +p.getUsername()+"_"+ score);
    ...
    public ConfidenceTaskController(CCCONFIDENCE cC, ConfidenceTaskControllerSequence ctcs,String identifierOfCTC, String experimentalCondition, int numberOfIndividualTrialsPerStage){
        this.cC=cC;
        this.ctcs=ctcs;
    ...
    long fixationtime =2500;
    long stimulustime =100;
    ...
    public synchronized void resetDataForTrial(){
     ...
     public synchronized void saveState(){
           ...
           cC.getC().saveDataToConversationHistory(cC.getDescriptionForP(pA)+"INTERVENTION", identifierOfClass+"//"+experimentCondition+"//"+individualTrialNumber +"//"+stateAsString);
    ...
    public void processChatText(final Participant p, MessageChatTextFromClient mct){
         ...
         cC.getC().saveDataToConversationHistory(p, cC.getDescriptionForP(p)   +"TASKMOVE",text);
         ...
         if(state==state0WAITINGFORSTART){
              ...
              if(p==pA & text.equalsIgnoreCase("/start")) {
                  ...
                  cC.getC().sendArtificialTurnToRecipient(p, "Thankyou...please wait for other participant", 0);
              }
             ...
             if(new Date().getTime()<state1ProjectedTimeOfSendingResponse){
                 cC.getC().sendArtificialTurnToRecipient(p, "****YOU SHOULD WAIT TILL YOU HAVE SEEN ALL THE IMAGES!***", 0, cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTTYPEDTOOSOON");
                 return;
             }
             if(! (text.equalsIgnoreCase("/1")|(text.equalsIgnoreCase("/2")))){
                 cC.getC().sendArtificialTurnToRecipient(p, "****YOU NEED TO TYPE EITHER  /1 or /2 ***", 0,cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADETYPE");
                 return;
             }
             if(text.equalsIgnoreCase("/1")&&p==pA){
                  pA__state1SelectionOfA=1;
                  this.pA__TimeOnServerOfIndividualSelection=mct.getTimeOnServerOfReceipt().getTime();
                  this.pA__TimeOnClientOfIndividualSelection=mct.getTimeOnClientOfCreation().getTime();
             ...
             if(text.equalsIgnoreCase("/1")&&p==pB){
                 ...
                 this.pB__TimeOnServerOfIndividualSelection=mct.getTimeOnServerOfReceipt().getTime();
                 this.pB__TimeOnClientOfIndividualSelection=mct.getTimeOnClientOfCreation().getTime();
             ...
             if(pA__state1SelectionOfA!=-1 && pB__state1SelectionOfB!=-1){
                  if(pA__state1SelectionOfA==this.state1_PatchIsInFirstOrSecond&&pB__state1SelectionOfB==this.state1_PatchIsInFirstOrSecond){
                      cC.getC().sendArtificialTurnToRecipient(pA, "****CORRECT***", 0,cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADETYPE_SENTTOCHATFRAME");
                      cC.getC().sendArtificialTurnToRecipient(pB, "****CORRECT***", 0,cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADETYPE_SENTTOCHATFRAME");
                     ...
                     cC.getC().sendArtificialTurnToRecipient(pA, "****WRONG***", 0,cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADETYPE_SENTTOCHATFRAME");
                     cC.getC().sendArtificialTurnToRecipient(pB, "****WRONG***", 0,cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADETYPE_SENTTOCHATFRAME");
                    ...
                    if(pA__state1SelectionOfA==state1_PatchIsInFirstOrSecond){
                        cC.getC().saveDataToConversationHistory(pA,cC.getDescriptionForP(p)+"SELECTIONINFO" , "MADE CORRECT SELECTION: "+pA__state1SelectionOfA );
                        cC.getC().saveDataToConversationHistory(pB,cC.getDescriptionForP(p)+"SELECTIONINFO" , "MADE WRONG SELECTION: "+pB__state1SelectionOfB );
                        ...
                        cC.getC().saveDataToConversationHistory(pA,cC.getDescriptionForP(p)+"SELECTIONINFO" , "MADE WRONG SELECTION: "+pA__state1SelectionOfA );
                        cC.getC().saveDataToConversationHistory(pB,cC.getDescriptionForP(p)+"SELECTIONINFO" , "MADE CORRECT SELECTION: "+pB__state1SelectionOfB );
                            ...
                            if(pA==cTC.participant__state2PersonWhoChooses){
                                   ...
                                   // cTC.cC.getC().sendArtificialTurnFromApparentOriginToRecipient_NoUsername(pA,pA, "**************WHAT IS YOUR JOINT DECISION?****************", cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_MUSTMAKECHOICE");
                                    ...
                                    //
                                     ...
                                     cTC.cC.getC().sendArtificialTurnToRecipient(pA, "**************WHAT IS YOUR JOINT DECISION?****************", 0,0,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_MUSTMAKECHOICE");
                                     cTC.cC.getC().sendArtificialTurnToRecipient(pB, "**************WHAT IS YOUR JOINT DECISION?****************", 0,2,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_DOESNTMAKECHOICE");
                                    ...
                                    //
                                        ...
                                        cTC.cC.getC().sendArtificialTurnToRecipient(pB, "**************WHAT IS YOUR JOINT DECISION?****************", 0,0,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_MUSTMAKECHOICE");
                                        cTC.cC.getC().sendArtificialTurnToRecipient(pA, "**************WHAT IS YOUR JOINT DECISION?****************", 0,2,  cC.getDescriptionForP(p)+"TASKMOVE_PARTICIPANTMADEDIFFERENTSELECTIONS_DOESNTMAKECHOICE");
             ...
             if(p!=this.participant__state2PersonWhoChooses){
                 cC.getC().sendArtificialTurnToRecipient(p, "****You can't choose. Your partner has to choose***", 0,cC.getDescriptionForP(p)+"TASKMOVE_JOINTDECISION_WRONGPARTICIPANTTRIEDTOANSWER");        
                 return;
             }
             else if(p==this.participant__state2PersonWhoChooses){
                 String id = ""; 
                 if(! (text.equalsIgnoreCase("/1")|(text.equalsIgnoreCase("/2")))){
                        cC.getC().sendArtificialTurnToRecipient(p, "****YOU NEED TO TYPE EITHER  /1 or /2 ***", 0,cC.getDescriptionForP(p)+"TASKMOVEJOINTDECISION_PARTICIPANTMADETYPEO");
                        return;
                  }
                   ...
                   if(p==pA){
                       this.pA__timeOnServerOfJointSelection=mct.getTimeOnServerOfReceipt().getTime();
                       this.pA__timeOnClientOfJointSelection=mct.getTimeOnClientOfCreation().getTime();
                       ...
                       this.pB__timeOnServerOfJointSelection=mct.getTimeOnServerOfReceipt().getTime();
                       this.pB__timeOnClientOfJointSelection=mct.getTimeOnClientOfCreation().getTime();
                       if(text.equalsIgnoreCase("/1")){
                            this.pA__JointSelection=1;         
                       }
                       else if (text.equalsIgnoreCase("/2")){
                  ...
                  cC.getC().saveDataToConversationHistory(p,cC.getDescriptionForP(p)+"JOINTSELECTIONINFO" , id);
                 ...
                 //gotoSTATE1_SendNewStimulusSet();
                   if(p==pA){
                       this.pA__TimeOnServerOfSelectionDoubleSlash=mct.getTimeOnServerOfReceipt().getTime();
                       this.pA__TimeOnClientOfSelectionDoubleSlash=mct.getTimeOnClientOfCreation().getTime();
                   }
                   else if(p==pB){
                       this.pB__TimeOnServerOfSelectionDoubleSlash=mct.getTimeOnServerOfReceipt().getTime();
                       this.pB__TimeOnClientOfSelectionDoubleSlash=mct.getTimeOnClientOfCreation().getTime();
                   }
   ...
   public void participantRejoinedConversation(Participant p){
       ...
       cC.getC().saveDataToConversationHistory(cC.getDescriptionForP(p), "CRASH RECOVERY "+p.getUsername()+"" );
       this.gotoSTATE1_SendNewStimulusSet();
   }
