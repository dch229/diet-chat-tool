 ...
 * @author sre
 */
public class JFrameGridStimuli extends JFrame implements ActionListener{
    ...
    public JFrameGridStimuli(ConnectionToServer cts,   int rows,int columns, int widthheight)  {
        this.cts=cts;
        north = new JPanel();
    ...
    public void setImageSelected( JPanel jp,SerializableImage si, long timeOfPress){
        ...
        try{
        MessageGridStimuliSelectionFromClient mgss = new MessageGridStimuliSelectionFromClient(cts.getEmail(),cts.getUsername(), this.serverIDOfSet,index, si.getName(),timeOfPress);
    ...
    public void actionPerformed(ActionEvent e) { 
        MessageGridStimuliSelectionFromClient mgss = new MessageGridStimuliSelectionFromClient(cts.getEmail(),cts.getUsername(), serverIDOfSet, -1, "Select",e.getWhen());
        cts.sendMessage(mgss);
    }
