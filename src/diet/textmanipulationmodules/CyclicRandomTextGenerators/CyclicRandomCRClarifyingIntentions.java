...
public class CyclicRandomCRClarifyingIntentions extends CyclicRandomTextGenerator{
    ...
    public CyclicRandomCRClarifyingIntentions() {
         File f = new File(System.getProperty("user.dir")+File.separator+"experimentresources"+File.separator+"mazegame"+File.separator+"crintention"+File.separator+"crintention.txt");
