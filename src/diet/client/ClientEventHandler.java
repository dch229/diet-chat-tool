...
public class ClientEventHandler {
    ...
    MostRecentPriorChatTextByOther mrpbo = new MostRecentPriorChatTextByOther();
    ...
    public  void appendWithCaretCheck(String prefix,String text, int windowNumber, int stylenumber ) {
        ...
        //if(this.keyspressedSinceLastTextEntry.size()==0){
            this.mrpbo.storeChatTextFromOtherParticipant(prefix,text);
        //} 
        if(jcf instanceof JChatFrameMultipleWindowsWithSendButton || jcf instanceof JChatFrameMultipleWindowsWithSendButtonOneTurnAtATime){
            String s ="";
            String t ="";
            ...
            if(text==null)text ="";
            if(stylenumber==0){
                if(prefix!=null&&prefix!="")jcf.appendWithCaretCheck(prefix, windowNumber, "hs");
                jcf.appendWithCaretCheck(text+"\n", windowNumber, "ns"); 
            }
            else{
                if(prefix!=null&&prefix!="")jcf.appendWithCaretCheck(prefix, windowNumber, "h"+stylenumber);
    ...
    public void sendButtonPressed() {
        if (allowTextEntryToBeSentToServerAndAppendedToPane) {
            String[] priorChatText = mrpbo.getMostRecentChatTextFromOtherParticipant();
           ...
           if(jcf instanceof JChatFrameMultipleWindowsWithSendButtonWidthByHeight){
            ...
            cts.sendChatText(text, startOfTyping, currentTurnBeingConstructedHasBeenBlocked, keyspressedSinceLastTextEntry,priorChatText);
            currentTurnBeingConstructedHasBeenBlocked = false;
            jcf.setTextEntryField("");
            clearKeypresses();
            this.mrpbo.clearChatTextFromOtherParticipcant();
        }
    ...
    public void wYSIWYGDocumentHasChangedReplaceDEPRECATED(String text, int offset, int length) {
        try {
             String[] priorChatText = mrpbo.getMostRecentChatTextFromOtherParticipant();
            cts.sendWYSIWYGDocumentHasChangedInsert(text, offset, length, "DEPRECATED", priorChatText);
        //System.out.println("WYSIWYGIN CLEVENTHANDLER2");
        } catch (Exception e) {
            // EMUI.println(cts.getUsername(),"ERROR IN CLEVENTHANDLER");
        }
...
//----------------------------------------------------------------------------------------------------------
   ...
   //-----------------------------------------------------------------------------------------------------------
    ...
    public void changeInterfaceProperties(int newInterfaceproperties, Object value, Object value2){
        ...
        else if(newInterfaceproperties==diet.message.MessageChangeClientInterfaceProperties.changeMazeWindow){
                    try{
        ...
        jcf.changeInterfaceProperties(newInterfaceproperties, value);
        // System.exit(-444445);
    }
