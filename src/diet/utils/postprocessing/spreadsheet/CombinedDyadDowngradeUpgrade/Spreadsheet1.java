...
public class Spreadsheet1 {
    ...
    public void loadExperiment(){
        ...
        Dyad1 currentDyad = null;
        
        String[] rowHeader = str.split("[|]");
        
        
        //int uniqID_index = findColumnINDEX("uniqid",rowHeader);
        int participantID_index = findColumnINDEX("Sender",rowHeader);
        int sender_index = findColumnINDEX("Sender",rowHeader);
        int dyadNo_index = findColumnINDEX("Pair",rowHeader);
        int dyadNoCorrected_index = findColumnINDEX("Pair",rowHeader);
        ...
        int text_index = findColumnINDEX("text",rowHeader);
        int desctype_index = findColumnINDEX("Desc TyPe",rowHeader);
        int turntype_index = findColumnINDEX("turntype",rowHeader);
        int recipient_index = findColumnINDEX("recipients",rowHeader);
        int cbyctype_index = findColumnINDEX("Turntype",rowHeader);
        ...
        while ((str = in.readLine()) != null) {
            ...
            if(currentDyad==null) {
                currentDyad = new Dyad1(string3,string3DyadNoCorrected);
    ...
    public  Spreadsheet1(){
        ...
        for(int i=0;i<this.dyads.size();i++){
            Dyad1 d = (Dyad1)dyads.elementAt(i);
    ...
    public static void main(String[] args){
        ...
        Spreadsheet1 s = new Spreadsheet1();
    ...
    public void writeSpreadsheetToFile(){
        ...
        for(int j=0;j<this.dyads.size();j++){
           Dyad1 d = (Dyad1)dyads.elementAt(j);
