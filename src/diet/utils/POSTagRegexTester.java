...
public class POSTagRegexTester {
	...
	public POSTagRegexTester(String regexFile, String misspellingsFile) throws Exception {
		...
		String taggerFile = System.getProperty("user.dir") +File.separator+"experimentresources"+ File.separator
	...
	public static void main(String a[]) throws Exception {
		String regexFile = System.getProperty("user.dir")+File.separator+"experimentresources"
				+ File.separator + "fragmentFilters" + File.separator
				+ "constBoundaryRegexes.txt";
		String misspellingsFile=System.getProperty("user.dir")+File.separator+"experimentresources"
		+ File.separator + "fragmentFilters" + File.separator
		+ "misspellings.txt";
