 ...
 * @author sre
 */
public class MessageGridStimuliSelectionFromClient extends MessageTask{
    ...
    public MessageGridStimuliSelectionFromClient(String email, String userName, long serverIDD, int position, String nameOfImage, long timeOnClientOfSelection)
    {
